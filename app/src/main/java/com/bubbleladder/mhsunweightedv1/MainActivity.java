...
public class MainActivity extends Activity{
    ...
    private View buildUi(){
        ...
        root.addView(tv("보글사다리 · MHS 무가중 V1",24,Color.WHITE,true));TextView sub=tv("모양 전개 학습 · 3칸 메인 / 4칸 확인 / 5칸 보조 · 최고1픽 1개",12,Color.rgb(110,231,183),false);sub.setPadding(0,dp(4),0,dp(14));root.addView(sub);
